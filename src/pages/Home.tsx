      ...
      <section className="relative pt-36 pb-20 md:pt-48 md:pb-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative w-full h-[320px] md:h-[400px] flex items-center justify-center">
            ...
            <svg viewBox="0 0 400 400" className="w-full h-full max-w-[380px] drop-shadow-[0_0_30px_rgba(0,240,255,0.15)]">
              {/* Connection Lines */}
              <motion.line
                x1="200" y1="200" x2="200" y2="80"
                stroke="#00f0ff" strokeWidth="1.5" strokeDasharray="3 3"
                animate={{ strokeDashoffset: [0, -10] }}
                transition={{ repeat: Infinity, duration: 2, ease: 'linear' }}
              />
              <motion.line
                x1="200" y1="200" x2="310" y2="150"
                stroke="#3b82f6" strokeWidth="1.5"
                animate={{ opacity: [0.3, 0.8, 0.3] }}
                transition={{ repeat: Infinity, duration: 3, ease: 'easeInOut' }}
              />
              <motion.line x1="200" y1="200" x2="280" y2="290" stroke="#00f0ff" strokeWidth="1.5" />
              <motion.line x1="200" y1="200" x2="120" y2="290" stroke="#3b82f6" strokeWidth="1.5" strokeDasharray="4 4" />
              ...
              />
              <text x="200" y="203" fill="#00f0ff" fontSize="10" fontWeight="bold" fontFamily="var(--font-sans)" textAnchor="middle">ALT</text>
              ...
              >
                ...
                <text x="200" y="52" fill="#fff" fontSize="8" fontWeight="bold" fontFamily="var(--font-mono)" letterSpacing="1" textAnchor="middle">APP DEV</text>
              </motion.g>
              ...
              >
                ...
                <text x="310" y="122" fill="#fff" fontSize="8" fontWeight="bold" fontFamily="var(--font-mono)" letterSpacing="1" textAnchor="middle">R&D</text>
              </motion.g>
              ...
              >
                ...
                <text x="280" y="322" fill="#fff" fontSize="8" fontWeight="bold" fontFamily="var(--font-mono)" letterSpacing="1" textAnchor="middle">PROJECTS</text>
              </motion.g>
              ...
              >
                ...
                <text x="120" y="322" fill="#fff" fontSize="8" fontWeight="bold" fontFamily="var(--font-mono)" letterSpacing="1" textAnchor="middle">EVENTS</text>
              </motion.g>
              ...
              >
                ...
                <text x="90" y="122" fill="#fff" fontSize="8" fontWeight="bold" fontFamily="var(--font-mono)" letterSpacing="1" textAnchor="middle">COMMUNITY</text>
              </motion.g>
            </svg>
          </div>
